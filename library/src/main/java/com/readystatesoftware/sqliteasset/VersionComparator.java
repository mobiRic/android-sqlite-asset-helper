...
/**
 * Compare paths by their upgrade version numbers, instead of using alphanumeric comparison on plain
 * file names. This prevents the upgrade scripts from being applied out of order when they first
 * move to double-, triple-, etc. digits.
 * <p>
 * For example, this fixes an upgrade that would apply 2 different upgrade files from version 9 to
 * 11 (<code>..._updated_9_10</code> and <code>..._updated_10_11</code>) from using the
 * <em>incorrect</em> alphanumeric order of <code>10_11</code> before <code>9_10</code>.
 * </p>
 */
class VersionComparator implements Comparator<String>
{
	 ...
	 *                thrown if the strings are not in the correct upgrade script format of:
